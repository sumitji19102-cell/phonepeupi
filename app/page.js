  ...
  return (
    <div className="bg-black min-h-screen font-sans text-white">
      ...
      <div className="mt-2 bg-[#171717] rounded-[14px] p-3 px-4 mx-2 ">
        ...
        <div className="text-[17px] font-bold">Paid to</div>
        ...
        <div className="flex items-center mt-3">
          ...
          <div className="flex-1">
            ...
            <div className="text-[16px] mt-[-4px] text-gray-300 font-normal">
              {upi}
            </div>
          </div>
        ...
        {/* ✅ FIXED SENT TO */}
        <div className="flex items-center text-[14px] text-gray-300 font-normal mt-1">
